            ...
            <div className="flex-buyBox container">
                ...
                <div style={{padding: '10px'}}>
                    ...
                    <div style={{padding: '20px 0'}}>
                        <p className="text-gray" style={{fontSize: '20px'}}>Remaining Amount:</p>
                        ...
                        <div className="flex">
                            ...
                            <h3 style={{padding: '0 10px', fontSize: '30px'}}>0.3 BNB</h3>
                        </div>
                        <button className="text-white bg-black c-pointer button-buyBox transition bg-hover">BUY NOW
                        </button>
                        <div>
                            <b>Contract Address</b>
                            <p className="text-gray">0xE8568408C33f9A407Fe403754c48c257FA250b1A</p>
                        </div>
                    </div>
                </div>
            </div>
